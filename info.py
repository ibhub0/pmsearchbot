...
URL = "https://pmsearchbot-infinitybotz.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://pmsearchbot-infinitybotz.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://pmsearchbot-infinitybotz.onrender.com/".format(FQDN)
else:
    URL = "https://pmsearchbot-infinitybotz.onrender.com/".format(FQDN)



LANGUAGES = ["english", "eng", "bengali", "ben", "hindi", "hin", "malayalam", "mal", "tamil", "tam", "telugu", "tel", "kannada", "kan", "marathi", "mar"]
